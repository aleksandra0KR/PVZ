// Code generated by protoc-gen-go-grpcPVZ. DO NOT EDIT.
// versions:
// - protoc-gen-go-grpcPVZ v1.5.1
// - protoc             v5.27.3
// source: pvz.proto
package grpcPVZ
...
// is compatible with the grpcPVZ package it is being compiled against.
// Requires gRPC-Go v1.64.0 or later.
const _ = grpc.SupportPackageIsVersion9

const (
	PVZService_GetPVZList_FullMethodName = "/PVZService/GetPVZList"
)
...
// It's only intended for direct use with grpcPVZ.RegisterService,
